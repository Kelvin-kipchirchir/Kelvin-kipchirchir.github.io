                    ...
                    <section class="cards" style="display: grid;grid-template-columns: (auto-fill,minmax(250px,1fr);grid-auto-rows: minmax(200px,auto);grid-gap: 1rem);" >
                      <article class="card" style="border:2px solid #e7e7e7;border-radius: 4px;padding: .5rem;box-shadow: 0 2px 2px rgba( 0,0,0,0.15);display: flex;">
                        <picture class="thumbnail" >
                          <img class="category_01" src="{{url ('public/images/'.$experience->icon)}}" style="display: block;border:0;width: 10%;height: auto;" class="img-responsive" alt="" >
                    <div class="content-main single-post padDiv">
                           <h4><a href="#">{{$experience->role}}</a></h4>
                           <h4><a href="#">{{$experience->place}}</a></h4>
                        </header>
                        </picture>
                        <header>
                        ...
                        <ul class="list-unstyled mb-0">
                          <li class="date">Location:<a href="#">{{$experience->location}}</a></li>
                          <li class="date">start date:<a href="#">{{$experience->start_date}}</a></li>
                          <li class="date">end date:<a href="#">{{$experience->end_date}}</a></li>
                        </ul>
                      </div>
                        <div class="card-content" style="font-size: .75rem;display: flex;">
                          <p class="date">Duties and achievement:<br><a href="#">{{$experience->activities}}</a></p>
                        </div>
                        <footer>
